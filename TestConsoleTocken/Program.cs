...
namespace TestConsoleTocken
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var client = new LocalhostGPGHostedFields.hostedFieldsSoapClient("hostedFieldsSoap"))
            {
                client.GetTokenizewithCustomerProfile(dataToPost);
            }
